        ...
        <body>
            <form method = "POST" action = "signup_simpan.php"> 
                <p>ID Pengguna (No. KP): <br> <!-- input username -->
                    <input type = "text" name = "username" placeholder = "12 nombor tanpa -" minlength = "12" maxlength = "12" size = "30" required autofocus>
                </p>
                <p>Kata Laluan: <br> <!-- input password -->
                    <input type = "text" name = "password" placeholder = "4 hingga 10 huruf/nombor" minlength = "5" maxlength = "20" size = "30" required>
                </p>
                ...
                <p>Nombor Telefon: <br> <!-- input nombor telefon -->
                    <input type = "text" name = "nomhp" placeholder = "Nombor Telefon tanpa -" maxlength = '13' size = "30" onkeypress = 'return event.charCode >= 48 && event.charCode <= 57' required>
                </p><br>
                <div>
