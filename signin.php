...
<form method = "post" action="signin_semak.php">
    <div>
        No. Kad Pengenalan Anda: <br>
        <input onblur="checkLength(this)" type="text" name="username" placeholder="Sila isi" maxlength="12" size="25" onkeypress='return event.charCode >=48 && event.charCode <=57'required autofocus />
        <script>
